...
label_conv.grid(row=1, column=0)
...
combo_type.grid(row=0, column=1)
...
label_value.grid(row=2, rowspan=2, column=0)
...
combo_conv.grid(row=1, column=1)
...
text_value = ttk.Entry(frame, width=25)
text_value.grid(row=2, column=1)
text_value.insert(0, '0')

text_conv = ttk.Entry(frame, width=25)
text_conv.grid(row=3, column=1)
